<template>
    <!-- Блок диалога -->
    <div class="d-flex pb-6 mr-8">
        <v-responsive aspect-ratio="4 / 3" class="d-flex border-pink pa-4">
            <div class="d-flex flex-column" style="max-width: 60%;">
                <p class="text-body pa-4 bg-indigo-darken-4" style="align-self: baseline">Text message fjfj fjkdhkkd ksjdkse vsdfkjsfgf lorem<p class="text-disabled">10:15</p></p>
            </div>
        </v-responsive>
    </div>
