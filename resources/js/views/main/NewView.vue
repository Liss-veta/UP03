  ...
  <div class="mt-12 d-flex flex-column align-center justify-center">
    ...
    <div class="d-flex justify-center w-75 mt-12">
      <v-sheet class="bd pa-2 w-100">
        <v-slide-group filter show-arrows class="d-flex justify-center w-100">
          <v-slide-group-item v-for="n in 1" :key="n" class="w-100">
            <v-chip-group v-model="amenities" column :color="isSelected ? 'green' : 'pink-lighten-4'">
              <v-chip variant="outlined" filter v-for="tag in tags" :key="tag" v-on:click="isSelected ? select_filter = 'Все посты' : select_filter = tag">
                  {{ tag }}
              </v-chip>
            </v-chip-group>
          </v-slide-group-item>
    ...
    <div class="w-100 mb-12"  v-if="posts.length > 0">
        ...
        <div class="w-75 mt-10" v-if="post.category == select_filter">
            ...
            <div class="post d-flex flex-row">
                ...
                <v-window-item class="h-auto big_height" value="option-1">
                    ...
                    <v-card-text class="w-100 d-flex px-12 py-8" style="min-height: 20vw; max-height: 20vw;">
                        <div class="w-50">
                ...
                <v-window-item class="w-100 min_height" value="option-2">
                    ...
                    <v-card-text class="h-100 d-flex flex-column justify-space-between" style="min-height: 20vw; max-height: 20vw;">
        ...
        <div class="w-75 mt-10" v-else-if="select_filter == 'Все посты'">
            <v-card class="bg-transparent">
            <div class="post d-flex flex-row">
                <v-tabs v-model="post.tab" direction="vertical" color="pink-lighten-4"
                class="d-flex flex-column justify-space-between">
